          ...
          <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-indigo-700 rounded-lg bg-indigo-900/50 backdrop-blur-sm md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-transparent">
            ...
            <li v-if="isAuthenticated" class="relative">
              ...
              <div v-if="profileMenuOpen" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2 z-50">
                ...
                <router-link v-if="user?.is_staff" to="/admin" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Admin</router-link>
      ...
      <div v-if="mobileMenuOpen" class="md:hidden bg-indigo-900/95 backdrop-blur-sm border-t border-indigo-700">
        <ul class="font-medium flex flex-col p-4 space-y-2">
          ...
          <li v-if="isAuthenticated" class="border-t border-indigo-700 pt-2">
            ...
            <router-link v-if="user?.is_staff" to="/admin" @click="toggleMobileMenu" class="block py-2 px-3 text-white rounded hover:bg-indigo-700">
              Admin
            </router-link>
